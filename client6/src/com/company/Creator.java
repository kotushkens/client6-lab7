    ...
    public static Integer getID() {
        ...
        public static void setHealth() {
            ...
            try {
                ...
                System.out.println("Ну емае вот опять что-то не так, попробуйте снова ввести ЦИФРЫ");
                setHealth();
            }
        ...
        public static void setHeartCount() {
            System.out.println("          Вводи короче цифру от 1 до 3))");
            Scanner scanner = new Scanner(System.in);
            ...
            try {
                ...
                if ((HC > 0) && (HC <= 3)) {
                    ...
                    System.out.println("Кажется, кто-то мертв внутри ну или тахикардия. Попробуй снова");
                    setHeartCount();
                }
        ...
        public static void setHeight() {
            ...
            try {
                ...
                System.out.println("Не знаем, что могло пойти не так, но что-то пошло не так. Попробуйте снова ввести ЦИФРУ");
                setHeight();
            }
        }
